% 根据7a3改编写
function [sys,x0,str,ts,simStateCompliance] = pifun8a2b2b(t,x,u,flag)
...
if u(2)>5400
    apclimit=(u(2)-5400)*7/2100;
else
    apclimit=0;
end
if thetaon_apc>apclimit          %让开通角在500-740之间从0到6
    thetaon_apc=apclimit;
elseif thetaon_apc<(-apclimit)
    thetaon_apc=-apclimit;
end
...
thetadvance=2;
if thetaon_apc>(8-thetadvance)          %让开通角在-2到11之间
