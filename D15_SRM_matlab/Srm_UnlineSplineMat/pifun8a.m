% 根据7a3改编写
function [sys,x0,str,ts,simStateCompliance] = pifun8a(t,x,u,flag)
...
if u(2)>3000
    if u(1)>u(2)
        if iDes_global>iDesIntUp_global+250
            iDes_global=iDesIntUp_global+250;
        end
    end
end
...
if thetaon_apc>(9-thetadvance)          %让开通角在-3到11之间
    thetaon_apc=9-thetadvance;
