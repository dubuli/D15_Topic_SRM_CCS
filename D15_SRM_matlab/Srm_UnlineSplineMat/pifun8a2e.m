% 根据7a3改编写
function [sys,x0,str,ts,simStateCompliance] = pifun8a2e(t,x,u,flag)
...
iDesInt_global=iDesInt_global+(u(1)-u(2))/3;
...
iDes_global=(u(1)-u(2))*4+iDesInt_global; %ides output
...
if u(2)>6500
    thetaon_apc=thetaon_apc_int+(u(1)-u(2))/200;
elseif u(2)<6500
    thetaon_apc=thetaon_apc*0.9993;    
end
