...
#define	ON_FWD	GioDatRegs.GPFCLEAR.bit.GPIOF9=1
#define	OFF_FWD	GioDatRegs.GPFSET.bit.GPIOF9=1
#define	T_FWD	GioDatRegs.GPFTOGGLE.bit.GPIOF9=1

#define	ON_RVS	GioDatRegs.GPFCLEAR.bit.GPIOF10=1
#define	OFF_RVS	GioDatRegs.GPFSET.bit.GPIOF10=1
#define	T_RVS	GioDatRegs.GPFTOGGLE.bit.GPIOF10=1

#define	ON_BLK	GioDatRegs.GPFCLEAR.bit.GPIOF11=1
#define	OFF_BLK	GioDatRegs.GPFSET.bit.GPIOF11=1
#define	T_BLK	GioDatRegs.GPFTOGGLE.bit.GPIOF11=1

#define	OFF_BUZZER	GioDatRegs.GPFSET.bit.GPIOF12=1
#define	ON_BUZZER	GioDatRegs.GPFCLEAR.bit.GPIOF12=1

#define ON_RELAY1   GioDatRegs.GPBCLEAR.bit.GPIOB13=1
#define	OFF_RELAY1	GioDatRegs.GPBSET.bit.GPIOB13=1
...
#define ADC_DEFAULTS { _IQ(0.0),_IQ(0.0),_IQ(0.0),_IQ(0.0),0,    \
...
typedef DIFFER *DIFFER_handle;
#define DIFFER_DEFAULTS{ _IQ(0.0),_IQ(0.0),_IQ(0.0),\
                         (void (*)(Uint32))differ_calc\
                         }

void differ_calc(DIFFER_handle);
